...
\section{Greedy Approach}
    \begin{frame}{Greedy Approach}
		...
		\begin{tikzpicture} 
            ...
            % Girls
            \node[fill=green, rectangle] (f1) at (3,0) {1};
            \node[fill=cyan, rectangle] (f2) at (3,-0.8) {2};
            \node[fill=green, rectangle] (f3) at (3,-1.6) {3};
            \node[fill=green, rectangle] (f4) at (3,-2.4) {4};
            \node[fill=green, rectangle] (f5) at (3,-3.2) {5};
